    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h1>Thay Đổi Thông Tin <b> Sản Phẩm</b></h1>
                    </div>
                </div>
            </div>
            <form action="/admin?action=edit&id=${sessionScope.product.idProduct}" method="post">
                ...
                <table>
                    <tr>
                        ...
                        <td><select name="category" id="category">
                            <c:forEach var="c" items="${sessionScope.categories}">
                                <option class="nameCategory"
                                        value="${c.getIdCategory()}">${c.getNameCategory()}</option>
                            </c:forEach>
                        </select></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" name="nameProduct" id="nameProduct"
                                   value="${sessionScope.product.nameProduct}"></td>
                    </tr>
                    ...
                    <tr>
                        <td>Số lượng</td>
                        <td><input type="number" name="quantity" id="quantity" value="${sessionScope.product.quantity}">
                        </td>
                    </tr>
                    <tr>
                    <tr>
                        <td>Đã bán</td>
                        <td><input type="number" name="quantity_sold" id="quantity_sold"
                                   value="${sessionScope.product.quantity_sold}"></td>
                    </tr>
