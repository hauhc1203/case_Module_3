    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "edit":
                ...
                int quantity_sold= Integer.parseInt(req.getParameter("quantity_sold"));
                productDAO.edit(new Product(id,name,categoryDAO.findCByID(idCategory1),img,price1,quantity1,quantity_sold));
                resp.sendRedirect("/admin");
                break;
            case "delete":
                id = Integer.parseInt(req.getParameter("id"));
